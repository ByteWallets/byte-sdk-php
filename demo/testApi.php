...
$merchant_no = 310730; //商户号
$api_key= '7dd9a5c3eb6312a53cf9da813030625a1363ec0582f6020716c48fd12cf47b85';// apikey
$gateway_address= 'https://api.bytewallets.io/wallet'; //节点
$callUrl = "http://127.0.0.1:9501/"; //回调地址
/** @var BwsDispatch $result */
$result = new BwsDispatch([
...
//查询支持的交易对
// var_dump($result->supportCoins(true));exit;
...
//创建地址
//  var_dump($result->createAddress(0));
...
//验证地址合法性
// var_dump($result->checkAddress(0,'32S2unZzRKGDKLAturkERjEH1vwCnmAztR'));
//返回内容：  { ["code"]=> int(200) ["message"]=> string(7) "SUCCESS" ["data"]=> NULL }
// var_dump($result->existAddress(0,'32S2unZzRKGDKLAturkERjEH1vwCnmAztR'));
 //返回内容： { ["code"]=> int(200) ["message"]=> string(7) "SUCCESS" ["data"]=> NULL }

 //申请提币
var_dump($result->withdraw('sn00001', 0, 0,'32S2unZzRKGDKLAturkERjEH1vwCnmAztR',10));
